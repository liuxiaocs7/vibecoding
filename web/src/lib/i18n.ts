...
export const TRANSLATIONS = {
  en: {
    ...
    fetchModelsFail: 'Failed to fetch model list: {error}',
    fetchModelsOk: 'Fetched {count} models',
  ...
  zh: {
    ...
    fetchModelsRunning: '获取模型列表中…',
    fetchModelsFail: '获取模型列表失败: {error}',
    fetchModelsOk: '已获取 {count} 个模型',
    fetchModelsEmpty: '服务端未返回任何模型',
    repoTooltip: '仓库',
    branchTooltip: '分支',
